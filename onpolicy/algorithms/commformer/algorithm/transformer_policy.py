...
from onpolicy.algorithms.commformer.algorithm.cformer import CommFormer
...
class TransformerPolicy:
    ...
    def __init__(self, args, obs_space, cent_obs_space, act_space, num_agents, device=torch.device("cpu")):
        ...
        self.transformer = CommFormer(self.share_obs_dim, self.obs_dim, self.act_dim, num_agents,
