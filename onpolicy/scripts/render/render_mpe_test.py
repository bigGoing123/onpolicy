...
def main(args):
    ...
    if all_args.algorithm_name == "rmappo":
        ...
        print("u are choosing to use mappo ormat, we set use_recurrent_policy & use_naive_recurrent_policy to be False")
    ...
    # 获取模型路径
    from onpolicy.utils.util import get_path
    wandb_dir = Path(os.path.split(os.path.dirname(os.path.abspath(__file__)))[
                   0] + "/results") / all_args.env_name / all_args.scenario_name / all_args.algorithm_name / all_args.experiment_name
    all_args.model_path = get_path(wandb_dir)
    print(all_args.model_path)
